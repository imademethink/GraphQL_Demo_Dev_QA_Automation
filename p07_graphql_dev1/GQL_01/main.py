...
def resolve_product_suppliers(product_obj, info):
    # Fetch full supplier details based on the IDs stored in the product
    ids = product_obj.get("supplier_ids", [])
    return [suppliers_db.get(sid) for sid in ids]
